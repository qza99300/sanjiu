...
public class ProductController {
	...
	@ResponseBody
	public PageInfo<TbIntegralProduct> querryByLike(@RequestParam(value = "pn", defaultValue = "1") Integer pageNum,
	...
	@ResponseBody
	public ResultVO<Object> addProduct(TbIntegralProduct product, HttpServletRequest request) {
		// 设置创建时间
	...
	@ResponseBody
	public ResultVO<Object> updateOrder(TbIntegralProduct product,HttpServletRequest request) {
