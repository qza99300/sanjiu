			...
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-block">
						<input type="text" placeholder="请输入司机姓名" class="layui-input">
					</div>
				</div>
				...
				<div class="layui-inline">
					...
					<div class="layui-input-block">
						<input type="tel" placeholder="请输入车牌号" class="layui-input">
					</div>
				</div>
				...
				<div class="layui-inline">
					...
					<div class="layui-input-block">
						<input type="tel" placeholder="请输入驾驶证号" class="layui-input">
					</div>
				</div>
			...
			<fieldset class="layui-elem-field" style="margin-top: 20px;">
				...
				<form class="layui-form" action=""
					...
					<div class="layui-form-item2">
						<div class="layui-inline">
							<label class="layui-form-label2"><a style="color: red;">*</a>司机姓名</label>
							<div class="layui-input-block">
								<input type="text" id="" class="layui-input">
							</div>
						</div>
						<div class="layui-inline" style="margin-left: 10%;">
							<label class="layui-form-label2"><a style="color: red;">*</a>车牌号</label>
							<div class="layui-input-block">
					...
					<div class="layui-form-item2">
						<div class="layui-inline">
							<label class="layui-form-label2"><a style="color: red;">*</a>驾驶证号</label>
							<div class="layui-input-block">
								<input type="text" id="" class="layui-input">
							</div>
						</div>
						<div class="layui-inline" style="margin-left: 10%;">
							<label class="layui-form-label2">微信号</label>
							<div class="layui-input-block">
								<input type="text" class="layui-input">
							</div>
						</div>
							...
							<div class="layui-input-block">
								<div class="outer">
									<select name="province" id="province2">
										<option value="请选择">--请选择省--</option>
									</select> <select name="city" id="city2">
										<option value="请选择">--请选择市--</option>
									</select> <select name="town" id="town2">
										<option value="请选择">--请选择区--</option>
									</select>
								</div>
							</div>
