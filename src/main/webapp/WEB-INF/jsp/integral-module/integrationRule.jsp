...
<!-- 						<div class="layui-form-item2" id="updateOrderDiv"> -->
<!-- 							<div class="layui-inline"> -->
<!-- 								<label class="layui-form-label2">积分</label> -->
<!-- 								<div class="layui-input-block"> -->
...
// 					.append('<button ruleId = "' + this.ruleId + '" type = "button" class = "updateRuleModalBtn btn btn-sm btn-success" title="修改规则" ><i class="fa fa-qrcode"></i></button>')
						 btnTd.append('&nbsp;<button ruleId = "' + this.ruleId + '" type = "button" class = "deleteRuleBtn btn btn-sm btn-danger" title="删除规则" id="removeUserBtn"><i class="fa fa-trash"></i></button>');
	
					
	
					tr.append("<td>" + this.ruleId + "</td>")
