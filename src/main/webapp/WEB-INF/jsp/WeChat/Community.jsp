                         	...
                         	<c:forEach items="${list}" var="list">
                         		<li>
	                                ...
	                                <ul class="control">
	                                        ...
	                                        <li onclick="Fabulous(${list.topicId},this)"><div class="wrap"><center><img src="../static/WeChat/images/yule/iconfont-dianzan.png"><span id="zz">赞<c:if test="${list.likeCount!=0||list.likeCount!=null}">(${list.likeCount})</c:if></span></center></div></li>
	                                </ul>
	                            </li>
                         	</c:forEach>
